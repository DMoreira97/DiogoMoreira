                ...
                <Container className="no-padding">
                    <Row className="no-margin">
                        ...
                        <Col lg={6} md={6} sm={12} style={{
                            marginTop: '30px',
                            textAlign: 'left'}} >
                            <p>Late in 2019, as referred above, I took an interest in joining the freelancer.com community to try and get more professional experience. For this I tried to create my own brand. Of course this project isn't close to being finished, but with college and other projects I didn't yet get the time to keep this going.</p>
                        </Col>
                        <Col lg={6} md={6} sm={12} style={{
                            marginTop: '30px',
                            textAlign: 'left'}} >
                            <p>As a normal student learning a lot from the internet, I always had this need to try and repay the community. I'd do this by participating in forums and such. But then one day started my own youtube channel, with this same objective. I finished an HTML tutorial and started a CSS tutorial, but languages such as these ones are too exhaustive to explain and there are way better tutorials online. So I stopped. I took a step back, to learn more about video editing and finding new themes to talk about.</p>
                        </Col>
                        <Col lg={6} md={6} sm={12} style={{marginTop: '30px'}}>
                            <Card style={{ width: '100%',
                                color: 'var(--black-color)' }}>
                        ...
                        <Col lg={6} md={6} sm={12} style={{
                            marginTop: '30px',
                            textAlign: 'left'}} >
                            <p>Last summer I've made this website for my father's business. Everything is online and working but the process capability of the AWS free tier server is very little, so the gallery tab is extremely slow, I still need to find a solution for this.</p>
                        </Col>
                    </Row>
                </Container>
            </div>
